'use client';
// app/overtime-saturday/page.tsx
...
export default function OvertimeSaturdayPage() {
  ...
  const [otType, setOtType] = useState<Overtime['type']>('Sábado');
  const [defaultStart, setDefaultStart] = useState('07:00');
  const [defaultEndStandard, setDefaultEndStandard] = useState('12:00');
  const [defaultEndExtra, setDefaultEndExtra] = useState('17:00');
  ...
  function openModal() {
    setStep(1); setOtDate(today()); setOtType('Sábado');
    setDefaultStart('07:00'); setDefaultEndStandard('12:00'); setDefaultEndExtra('17:00');
  ...
  return (
    <AppShell>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <div style={{ fontSize: 32, fontWeight: 800, letterSpacing: -1, fontFamily: 'Outfit, sans-serif' }}>Hora Extra / Fim de Semana</div>
          <div style={{ color: 'var(--text-secondary)', fontSize: 14, marginTop: 4, fontWeight: 500 }}>Gestão de escalas de sábados e domingos</div>
        </div>
      ...
      <div className="card-premium" style={{ padding: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
          <div style={{ fontWeight: 600, fontSize: 15 }}>Escalas Registradas</div>
          ...
          <div key={ot.id} style={{ border: '1px solid var(--border-subtle)', borderRadius: 10, marginBottom: 12, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 18px', background: 'var(--bg-card)', flexWrap: 'wrap', gap: 10 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <span className="pill pill-yellow">{ot.type}</span>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Nova Escala de Fim de Semana" maxWidth={700}
        footer={
          <>
        ...
        {step === 1 && (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <div>
              ...
              <input className="field-input" value="Sábado" disabled />
            </div>
            <div>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.8px', marginBottom: 8 }}>Saída com Extra</div>
